...
django.jQuery(function() {
    ...
    var tinyMceConfig = {
        ...
        width: 800,
        height:200,
        theme_advanced_buttons1 : "bold,italic,underline,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,bullist,numlist,outdent,indent,separator,imagecms,link,unlink,forecolor,backcolor,hr,removeformat,separator,undo,redo,separator,code",
